      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 max-w-3xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              <span className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 font-semibold text-slate-700">Available: {sourceCounts.ALL}</span>
              <span className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 font-semibold text-slate-700">NGO: {sourceCounts.NGO}</span>
              <span className="rounded-full border border-slate-200 bg-slate-50 px-4 py-2 font-semibold text-slate-700">Startup: {sourceCounts.STARTUP}</span>
            </div>
          </div>
        </section>
              ...
              {['ALL', 'NGO', 'STARTUP'].map((source) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      backgroundColor: active ? '#0d9488' : BRAND.soft,
        ...
        {loading ? (
          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
            {[1, 2, 3, 4].map((value) => (
              <div key={value} className="flex h-72 flex-col rounded-2xl border border-slate-100 bg-white p-4 shadow-sm animate-pulse">
